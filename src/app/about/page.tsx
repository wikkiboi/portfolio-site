export default function AboutPage() {
  return (
    <main className="max-w-prose mx-auto px-4">
      <h1 className="text-center text-5xl py-3 mb-8">About Me</h1>
      ...
      <article>
        ...
        <p>
          ...
          their Full Stack JavaScript curriculum, where I picked up React, SQL,
        ...
        <p>
          ...
          projects. I&apos;ve built these projects over the past year or so,
          such as <a href="https://zenbu.netlify.app">zenbu</a> and{" "}
          <a href="https://github.com/wikkiboi/talkify-app">Talkify</a>, which
